...
ofstream outassemble("Code.asm");
ofstream outoptimize("optimized_code.asm");
ifstream inassemble;
...
func_declaration : type_specifier ID LPAREN parameter_list RPAREN SEMICOLON
        {
            ...
            $$ = new SymbolInfo("func_declaration","none");
 ...
 compound_statement
        {
            ...
            $$ = new SymbolInfo("func_definition","none");
...
parameter_list  : parameter_list COMMA type_specifier ID
        {
            ...
            $$ = new SymbolInfo("parameter_list","none");
...
compound_statement : LCURL dummy_enterScope statements RCURL
            {
                ...
                $$ = new SymbolInfo("compound_statement","none");
...
var_declaration : type_specifier declaration_list SEMICOLON
         {
            ...
            $$ = new SymbolInfo("var_declaration","none");
...
declaration_list : declaration_list COMMA ID
          {
            ...
            $$ = new SymbolInfo("declaration_list","none");
...
statements : statement
       {
        ...
        $$ = new SymbolInfo("statements","none");
...
expression_statement 	: SEMICOLON	
            {
                ...
                $$ = new SymbolInfo("expression_statement","none");
 ...
 expression : logic_expression
       {
        ...
        $$ = new SymbolInfo("expression","none");
...
logic_expression : rel_expression 
         {
            $$ = new SymbolInfo("logic_expression","none");
...
rel_expression	: simple_expression 
        {
            ...
            $$ = new SymbolInfo("rel_expression","none");
...
simple_expression : term 
        ...
        outputlog<<"simple_expression : term "<<endl;
            $$ = new SymbolInfo("simple_expression","none");
...
unary_expression : ADDOP unary_expression
        ...
        outputlog<<"unary_expression : ADDOP unary_expression "<<endl;
            $$ = new SymbolInfo("unary_expression","none");
...
argument_list : arguments
              {
                ...
                $$ = new SymbolInfo("argument_list","none");
